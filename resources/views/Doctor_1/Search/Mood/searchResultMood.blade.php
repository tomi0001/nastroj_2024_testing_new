                ...
                <tr class='moodClass{{$arrayList[$i]->id}}'>
                    ...
                    <td colspan="7" class="moodButton">
                        ...
                        <div >
                                   ...
                                   <div class="divButton">
                                        @if (!empty(\App\Models\Usee::ifExistUsee($arrayList[$i]->date_start,$arrayList[$i]->date_end,Auth::User()->id_users) ))
                                            <button class="btn-mood drugs" onclick="showDrugs('{{ route('Doctor.ajax.showDrugs')}}',{{$arrayList[$i]->id}})">pokaż leki</button>
                                        @else
                                   ...
                                   <div class="divButton">
                                        @if (!empty(\App\Models\Moods_action::ifExistAction($arrayList[$i]->id) ))
                                            <button class="btn-mood action" onclick="showAction('{{ route('Doctor.ajax.showAction')}}',{{$arrayList[$i]->id}})">pokaż akcje</button>
                                        @else
