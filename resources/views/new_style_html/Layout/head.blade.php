<link href="{{ asset('./styles/' . Auth::User()->css . '/css/Common1810.css') }}" rel="stylesheet">
        ...
        <link href="{{ asset('./styles/' . Auth::User()->css . '/css/Common360.css') }}" rel="stylesheet">
        <link href="{{ asset('./styles/' . Auth::User()->css . '/css/CommonAll.css') }}" rel="stylesheet">
        <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Architects+Daughter&display=swap" rel="stylesheet">
<link href="https://fonts.googleapis.com/css2?family=Architects+Daughter&family=Gochi+Hand&display=swap" rel="stylesheet">
<link href="https://fonts.googleapis.com/css2?family=Architects+Daughter&family=Gochi+Hand&family=Syncopate:wght@400;700&display=swap" rel="stylesheet">
        <link href="{{ asset('./styles/' . Auth::User()->css . '/css/font.css') }}" rel="stylesheet">
