...
<form id="formUpdateAction{{$idMood}}">
                                        ...
                                        <div class='main-action-edit-scroll' >
                                            <div id="parentsAction{{$idMood}}">
                                                ...
                                                @endphp
                                                 ...
                                                 <div class="rowPercent">
                                                     ...
                                                     @endif
                                                    <div class='main-action-edit-main actionMain{{$idMood}}'  id='divAction_{{$list->id}}_{{$idMood}}' onclick='selectedActionMainValue({{$list->id}},{{$loop->index}},{{$idMood}})'>{{$list->name}}</div>
                                                    <div class="main-action-edit-hidden main-action-edit-center" id='divActionPercent_{{$list->id}}_{{$idMood}}'>
                                      ...
                                      <button class="btn btn-primary btn-lg" onclick="updateActionForMood('{{ route('ajax.updateAction')}}',{{$idMood}})">Modyfikuj akcje</button>
                                      <div id="formResult{{$idMood}}"></div>
